...
public class Importxmlsucsses {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Importxmlsucsses window = new Importxmlsucsses();
	...
	private void initialize() {
		...
		JLabel lblCreatParty = new JLabel("import new  from Xml:    \r\n");
		...
		panel.add(txtKl);
		txtKl.setText("The new Location are importet sucssfully✅");
		txtKl.setColumns(10);
